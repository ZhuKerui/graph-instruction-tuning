...
def encode_with_completion_format(example, tokenizer, max_seq_length):
    ...
    assert (tokenized_prompt.input_ids == labels[:, :tokenized_prompt.input_ids.shape[1]]).all()
...
def main():
    ...
    #     d = train_dataset[index]
    #     logger.info(f"Sample {index} of the training set:\n{d}")
    #     input_texts = tokenizer.batch_decode(d["input_ids"])
    #     labels = d["labels"]
    #     assert len(input_texts) == len(labels)
    #     print(f"Input texts:\n{input_texts}")
    #     print("Label texts:")
    #     for t, label in zip(input_texts, labels):
    #         if label != -100:
    #             print(t, end=' ')
    #     print('\n')
